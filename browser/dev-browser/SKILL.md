...
自动化发布小红书图文笔记。See [references/xiaohongshu-publish.md](references/xiaohongshu-publish.md) for the complete guide covering:

- 常见问题解决（元素视口外、文件选择器超时等）
- 完整发布流程（导航、上传图片、填写内容、发布）
- 可复用的完整脚本示例
